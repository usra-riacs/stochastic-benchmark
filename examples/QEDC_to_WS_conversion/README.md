...
The bundled fixture is hand-authored synthetic sample data for exercising the
conversion path. It was not generated by rerunning QED-C, is not a
benchmark-quality dataset, and should not be used for performance conclusions.
