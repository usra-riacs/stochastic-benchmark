...
class TestBuildFamilyColorMap:
    def test_fa_star_and_fa_dagger_do_not_collide(self):
        ...
        # used to both draw from overlapping stretches of plt.cm.Blues, making
        # e.g. Fixed Angles*(p=6) and Fixed Angles+-dagger(p=6) nearly
        # indistinguishable even though that contrast is the point of the figure.
        labels = [
